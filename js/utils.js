 ...
 * @param {Array<object>} lines - An array of line objects, each with { x1, y1, x2, y2 }.
 * @param {number} canvasWidth - The width of the canvas.
 * @returns {boolean} - True if a connecting bridge exists, false otherwise.
 */
export function checkConnectivity(lines, canvasWidth) {
    if (lines.length === 0) {
        return false;
    }
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { intersects, checkConnectivity };
}
